...
| `authors_r` | string | Author list (comma-separated) |
| `journal_r` | string | Journal or venue name |
| `url_r` | string | Canonical URL |
| `openalex_id_r` | string | OpenAlex work ID (e.g. W1234567890) |
| `source` | string | Where this paper was discovered: `openalex`, `bob_reed`, `i4r`, `semantic_scholar` |
...
`validated_doi_o` and `validated_outcome` enable accuracy measurement by diffing against extracted values.
